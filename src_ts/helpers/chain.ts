...
import {IAuthorization, IIdentity} from "../types/eos";
...
export default class ChainHelper {
    ...
    constructor(public readonly _eos: any) {
    }
    ...
    async validateSign(
        ...
        for (let i in accountsStrs) {
            ...
            if (await Promise.resolve(plugin(account_name, recoverKey))) return recoverKey
        }
    }
